...
import cn.tanjianff.igoodo.db.repository.JdbcRepository.JdbcUserRepository;
...
public class TestJdbcUseerRepository {
    ...
    public void save(){
        ...
        IgdUser igdUser=new IgdUser(Double.parseDouble("432344543"),Double.parseDouble("45432"),
